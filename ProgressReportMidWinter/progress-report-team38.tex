...
\section{Problems and Solutions: Winter Midterm }
	...
	There was an influx of work as this first meeting was when the team was planning to have the mostly functional extension, and we where still having some problems with launching the custom UI from within VSCode, and we were still working on with dumby data as we were having trouble parsing out the information to create the logical links between the files within the projects the extension was trying to visualize. 
	We met with Chris Scaffidi and showed him the visual structure that our extension with the dumby data could create and he seemed really happy with the results.
	...
	\subsection{Week 3}
	In week three we worked on more minor changes that were later deprecated.
	...
	This introduced our most recent problem being that our extension will run fine on our development machines, but if downloaded from the marketplace the extension crashes.
	We 
