...
\section{Problems and Solutions}
	...
	Winter Break During Winter break, Sam, Eric and I were able to meet up and begin diving work amongst ourselves since we are all from the same hometown. 
	...
	Despite this, Scaffidi was happy with our progress thus far and set a few deadlines he wanted us to meet by the end of the next two months (February and March).
	...
	\subsection{Week 3} 
	That week was fairly slow for development. 
	The team worked individual on their components and we all met after our meeting with Vee to make sure we were on track. 
	I spent some time on the code that creates file nodes and links so that Eric’s UI would correctly represent them visually.
	
	\subsection{Week 4} 
	That week saw more progress as Eric got the UI to launch with VS Code automatically for the first time. 
	Sam and I worked on the parser and data structure to make sure it output adequate file node information for the UI. 
	Cramer got code highlighting working within VS Code, which will be useful for a future feature.
	
	\subsection{Week 5} 
	I wrapped up file node creation from the parser in the data structure. 
	...
	I set up the OneNote engineering notebook for our midterm progress report.
	\subsection{Week 7} 
	The team conducted a code review on the weekend, bringing us all to a better understanding of each others’ code components. 
	...
	\subsection{Week 8} 
	We met with Scaffidi that week, and while he was happy with our general progress, he still believed the usefulness of the UI was not where it needed to be. 
	...
	\subsection{Week 9} 
	Each team member worked individually added minor components to the UI and some functional elements of our extension that week. 
	I added buttons that allowed to user to configure the shape of the file node network in the UI and began adding the slide open window for a notification menu.
	
	\subsection{Week 10} 
	The team worked that week to complete the preliminary version of our Expo poster. 
