...
export function activate(context: vscode.ExtensionContext) {
    ...
    let previewUri = vscode.Uri.parse('Files://authority/Files');
    ...
    console.log('Congratulations, your extension "postalts" is now active!');
    ...
    let Run = vscode.commands.registerTextEditorCommand('extension.Run', (te, t) => {
