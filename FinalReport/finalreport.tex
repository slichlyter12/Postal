...
Other technology changes included using a custom implementation of the features provided by JavaScript's Lodash library and jQuery's NewsTicker library.\\
...
It is important to note that the team did not take any code from the project and only reffered to it as a guide for using the correct Node and Electron functionality.
