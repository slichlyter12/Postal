...
?>
    ...
    <div class="container">
			<h1 style="text-align: center;">The Triple Entente</h1>
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top:25px;">
            ...
            <div class="col-lg-7">
                ...
                //First query is to show relevant stats for the Entente nations, pulled from country, army, leader
                $sql = "SELECT Country_Name as 'Country Name', CONCAT(Leader.Title, ' ',Leader.Leader_Fname,' ',Leader.Leader_Lname) as 'Country Leader', Population, Alliance, Army.Manpower as 'Army Manpower'
                        ...
                        WHERE Alliance = 'Triple Entente';";
               //SUM function for manpower of the Entente, from Army table         
