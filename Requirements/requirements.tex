...
\subsection{Performance Requirements} 
We predict that the extention will be able to parse and interpret code projects with one hundred thousand lines of code quickly without noticeable lag. 
