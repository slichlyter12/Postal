...
% Document Title:
\def\doctitle{Requirements Document for Postal}

\markboth{Oregon State University}{\doctitle}

\begin{document}

\title{\Huge{\bfseries{\textsf{\doctitle}}}}
...
\begin{itemize}
	...
	Many of these rules will be based on W3 best practices for the particular parser.
