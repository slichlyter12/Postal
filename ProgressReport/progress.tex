...
\section{Problems and Solutions}
	...
	The beginning of our project was back in August when Sam told the rest of the tema about an oppurtunity that he had to work with Chirstopher Scaffidi on a senior design project. 
	The team all jumped on the oppurtunity to work together for a professor all everyone had had previously and throughly enjoyed.
	So Scaffidi tasked the team with coming up with project proposals.
	...
	Scaffidi chose a code base organization extension written for Visual Studio Code.
	...
	\subsection{Week 4}
	During the fourth week the Postal client had challenged to team with accelerating the developement process past the class.
	...
	These programs served as a learning experience for the team as we develope more complex extensions these examples gave us a framework of understanding of what the code of an extension looks like.
	...
	This task was fairly easy as the team had recieved feedback on the first draft and therefore had a knowledge of what was expected of them.
	...
	Now the team knew that it was going to be a web developement tool rather than instead of a general code organizer.
	This was great for the developement of the project, but this narrowing of scope was not communicated to the client. 
	...
	The only thing was that this program was not actually a Visual Studio Code extension but a seperately compiled program.
	...
	The tech document made the team look at alternatives for parts that each memeber had decided to focus on.
	...
	This document proved to be the most confusing as the team had a particularly dificult time figuring out the IEEE standard of the software design document. 
	...
	The client was happy with the prototype, but was not happy with learning that the scope of the project had been reduced.
	This was disappointing to the team.
